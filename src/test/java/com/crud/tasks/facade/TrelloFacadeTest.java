...
//        when(trelloValidator.validateTrelloBoards(mappedTrelloBoards)).thenReturn(mappedTrelloBoards);
    ...
    public void shouldCreateCard(){
        TrelloCardDto trelloCardDto = new TrelloCardDto("Test", "testing" , "test", "1");
        TrelloCard mappedTrelloCard = new TrelloCard("Test", "testing" , "test", "1");
        ...
        assertEquals(createdTrelloCard.getName(), testedTrelloCardDto.getName());
        assertEquals(createdTrelloCard.getShortUrl(), testedTrelloCardDto.getShortUrl());
        assertEquals(createdTrelloCard.getBadges(), testedTrelloCardDto.getBadges());
